...
<body>
 ...
 <form name="boardForm" id="boardForm" action="" method="POST">
	<div id="board_page">
		<div id="board_kind">
			<a href="AdminBoard.jsp"><span id="notice_board"></span></a> <a
				href="AdminQandABoard.jsp"><span id="qna_board"></span></a> <a
...
function allCk(objCheck){ 
	var checks = document.getElementsByName('board_chk');
...
function deleteGo(){
	if (confirm('정말로 삭제하시겠습니까?')){
		...
		boardForm.action = "deleteBoardPro.jsp";
		boardForm.submit();
	}
	return false;
}

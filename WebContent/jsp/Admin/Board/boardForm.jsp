...
%>
	...
	<form>
		...
		<div>
			<table id="reple">
				...
				<tr>
					...
					<td id="reple-day"><%=sdf.format(board_comment.getBoard_comment_date())%>
		...
		<div id="btnarea">
			...
			onclick="document.location.href='deletePro.jsp?review_board_num=<%=review_board.getReview_board_num()%>&pageNum=<%=pageNum%>'"> 

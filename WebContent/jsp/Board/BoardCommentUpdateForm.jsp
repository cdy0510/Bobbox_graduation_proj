		...
		<div>
			<table id="reple">
				...
				<tr>
					...
					<td colspan="3" id="reple-content"><input type="text" name="board_comment_content" value="<%=board_comment.getBoard_comment_content()%>"></td>
					...
					<td id="reple-delete"><input type="button" value="수정" onclick="goUpdate(<%=board_comment.getBoard_comment_num()%>)"></td>

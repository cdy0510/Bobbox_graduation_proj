...
<body>
	...
	<div id="board_area">			
		<table>
			...
			%>
			<tr id="table-content">
				<td id="board-num"><%=Admin_board.getAdmin_board_num()%></td>
    ...
    if (count > 0) {
        ...
        if (startPage > 10) { %>
          <a href="AdminBoardList.jsp?pageNum=<%= startPage - 10 %>">[이전]</a>
<%      }
        
        for (int i = startPage ; i <= endPage ; i++) {  %>
           <a href="AdminBoardList.jsp?pageNum=<%= i %>">[<%= i %>]</a>
<%      }
        
        if (endPage < pageCount) {  %>
        <a href="AdminBoardList.jsp?pageNum=<%= startPage + 10 %>">[다음]</a>
<%
        }
    }
%>
